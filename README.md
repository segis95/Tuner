...
- For each multiple <img src="https://render.githubusercontent.com/render/math?math=f"> of <img src="https://render.githubusercontent.com/render/math?math=f_{max}"> check whether <img src="https://render.githubusercontent.com/render/math?math=w_f"> is at least 80% of <img src="https://render.githubusercontent.com/render/math?math=w_{f_{max}}">. if it is, replace <img src="https://render.githubusercontent.com/render/math?math=f_{max}"> with such maximal possible value of <img src="https://render.githubusercontent.com/render/math?math=f"> satisfying this property;
